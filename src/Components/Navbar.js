...
export default function Navbar(props) {
  return (
      <nav className={`navbar navbar-expand-lg navbar-${props.mode}`} style={props.mode==='light'?{backgroundColor:'#adb5bd'}:{backgroundColor:'#000'}}>
...
Navbar.defaultProps = {
    title: "Set Application Title Here",
}
